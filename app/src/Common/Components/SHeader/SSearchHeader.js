...
const SSearchHeader = () => {
	return (
		<nav className="hidden w-1/2 h-full lg:flex lg:justify-start lg:items-center">
			<nav className="lg:ml-2 xl:ml-4 w-full lg:w-90% h-10 bg-black-1 border-2 border-opacity-40 flex justify-between items-center rounded-lg hover:border-red-2 transition-all">
				<input
					type="search"
