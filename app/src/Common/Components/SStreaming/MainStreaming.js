...
const MainStreaming = () => {
	...
	return (
		<nav
			className="mb-2 lg:m-0 w-full md:w-1/2 lg:w-1/2 xl:w-60% h-52 lg:h-60 bg-red-2 rounded-2xl flex justify-around"
			data-aos="fade-right"
		...
		>
			<nav className="w-45% h-auto flex flex-col justify-around items-center">
				<nav className="w-full">
					...
					<p className="text-sm xl:text-base text-white font-bold tracking-widest">
